...
function showCheckoutSummary() {
    ...
    document.getElementById("summary-base").innerText =
        `$${basePrice.toFixed(2)}`;

    document.getElementById("summary-fee").innerText =
        dripToggle.checked
            ? `$${hiddenFees.toFixed(2)}`
            : "$0.00";
    ...
    const trickList =
        document.getElementById("summary-tricks");

    trickList.innerHTML = "";

    if (scarcityToggle.checked) {
        trickList.innerHTML +=
            "<li>High Scarcity Pressure</li>";
    }
    ...
    if (socialToggle.checked) {
        trickList.innerHTML +=
            "<li>Artificial Stock Scarcity</li>";
    }

    if (trickList.innerHTML === "") {
        trickList.innerHTML =
            "<li>No retail tricks enabled</li>";
    }
...
function loadNextProduct() {
    ...
    scarcityToggle.checked = false;
    dripToggle.checked = false;
